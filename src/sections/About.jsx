        ...
        <div className="container mx-auto px-6 relative z-10">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div className="space-y-8">
                    ...
                    <div className="space-y-4 text-muted-foreground animate-fade-in animation-delay-200">
                        ...
                        <p>
                            ...
                            non-technical. To unwind, I’m usually lost in music and music videos, or catching up on
                            football highlights (the perfect way to stay in the game when I can't spare the time for
                            a full 90 minutes.
                        </p>
                    </div>
                ...
                <div className="grid sm:grid-cols-2 gap-6">
                    {highlights.map((item, idx) => (<div
                        key={idx}
                        className="glass p-6 rounded-2xl animate-fade-in"
                        style={{animationDelay: `${(idx + 1) * 100}ms`}}
                    >
                        <div
                            className="w-12 h-12 rounded-xl bg-primary/10 flex items-center justify-center mb-4 hover:bg-primary/20">
