...
export const Hero = () => {
    return (<section className="relative min-h-screen flex items-center overflow-hidden">
            ...
            {/* Content */}
            <div className="container mx-auto px-2 sm:px-3 pt-32 pb-20 relative z-10">
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="space-y-4">
                            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold leading-tight animate-fade-in animation-delay-100">
                                Mastering <span className="text-primary glow-text">digital</span>
                                <br/>
                                crafts with
                                <br/>
                            ...
                            <p className="text-md md:text-lg text-muted-foreground max-w-lg animate-fade-in animation-delay-200">
                    ...
                    <div className="relative animate-fade-in animation-delay-300 w-[90%] md:w-full">
                        {/* Profile Image */}
                        <div className="relative max-w-md mx-auto w-full max-w-full">
                            <div
                            ...
                            <div className="relative glass rounded-3xl p-4 glow-border">
                                ...
                                {/* Floating Badge */}
                                <div
                                    className="absolute -top-4 -right-2 md:-right-4 glass rounded-xl px-4 py-3 animate-float">
